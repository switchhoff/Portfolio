...
export const PATH_DATA: Record<number, PathObject> = {
  ...
  32: {
    ...
    name: "Shout a Round",
    category: "projects",
    description: "Track whose round it is across different groups of friends — create or join a tab, see the rotation clearly, and settle up fairly. No more \"I definitely shouted last time\" arguments.",
  ...
  36: {
    ...
    name: "MiniMize",
    category: "projects",
    description: "Minimal Android launcher built for intentional phone use — focus sessions, friction layers for distracting apps, a calm home screen with no algorithmic noise. Built in Jetpack Compose for people who want their phone to work for them, not against them.",
    tags: ["ANDROID", "UX"],
  ...
  57: {
    ...
    description: "PowerPots — a low-cost, community-centred ceramic water filter solution proposed to combat the effects of Tonga's volcanic eruption.",
    tags: ["HACKATHON"],
    links: [],
  },
  58: {
  ...
  64: {
    ...
    company: "Fortifyedge",
    role: "Chief Engineer",
    description: "I architecture robust software solutions implementing tactical AI models for edge deployment supporting human machine interface teaming. Leading a team, I deploy full-stack dashboards linked to wearables, translating complex signals into actionable insights. I work directly with military, police and firefighter operators to rapidly iterate on features.",
  ...
  84: {
    ...
    name: "LoverLamp",
    category: "projects",
    description: "Touch your lamp and your partner's lamp glows in response — anywhere in the world. Two ESP32-based lamps connected over the internet, no words needed. A small physical way to say \"thinking of you\" across any distance.",
    wip: true,
    links: [],
  },
  86: {
